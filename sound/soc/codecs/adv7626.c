...
static void config_transceiver_mode(struct adv7626_priv *adv7626)
{
	...
	/* Configure MAIN reg */
	regmap_multi_reg_write(adv7626->regmap[ADV7626_REG_MAIN], main_seq,
					ARRAY_SIZE(main_seq));
	...
	regmap_multi_reg_write(adv7626->regmap[ADV7626_REG_HDMI_RX1], hdmi_rx1_seq,
					ARRAY_SIZE(hdmi_rx1_seq));

	/* HDMI Rx2 Configuration - input TMDS Clock equal to 297MHz */
	regmap_multi_reg_write(adv7626->regmap[ADV7626_REG_HDMI_RX2], hdmi_rx2_seq,
					ARRAY_SIZE(hdmi_rx2_seq));
	...
	regmap_multi_reg_write(adv7626->regmap[ADV7626_REG_TxA_MAIN], hdmi_txa_seq,
					ARRAY_SIZE(hdmi_txa_seq));

	/* HDMI TxB Config */
	regmap_write(adv7626->regmap[ADV7626_REG_TxB_TEST], 0x24, 0x42);
	regmap_multi_reg_write(adv7626->regmap[ADV7626_REG_TxB_MAIN], hdmi_txb_seq,
					ARRAY_SIZE(hdmi_txb_seq));
